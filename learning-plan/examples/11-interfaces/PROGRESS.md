# Step 11 — Interfaces · Lesson progress

## Status
- **Phase 1 — Theory + examples:** 🟡 in progress
- **Phase 2 — Practice (`practice/`):** ⬜ not started
- **Lesson complete:** no
...
## Phase 2 — Practice
Hands-on build in `practice/11-interfaces/` (done after Phase 1).
- [ ] practice part defined
- [ ] practice part completed

## Notes
<!-- Jot anything that surprised you or you want to come back to. -->
- (none yet)

---
*High-level progress across all 26 steps lives in [../../PROGRESS.md](../../PROGRESS.md).*
