...
type EchoReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`                         // the echoed text
	ServedBy      string                 `protobuf:"bytes,2,opt,name=served_by,json=servedBy,proto3" json:"served_by,omitempty"`       // hostname of the echo container that answered
	ReceivedAt    string                 `protobuf:"bytes,3,opt,name=received_at,json=receivedAt,proto3" json:"received_at,omitempty"` // RFC3339 timestamp, set by the echo service
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EchoReply) GetServedBy() string {
	if x != nil {
		return x.ServedBy
	}
	return ""
...
func (x *EchoReply) GetReceivedAt() string {
	if x != nil {
		return x.ReceivedAt
	}
	return ""
...
const file_proto_echo_v1_echo_proto_rawDesc = "" +
	...
	"\tserved_by\x18\x02 \x01(\tR\bservedBy\x12\x1f\n" +
	"\vreceived_at\x18\x03 \x01(\tR\n" +
	"receivedAt2?\n" +
	"\vEchoService\x120\n" +
	"\x04Echo\x12\x14.echo.v1.EchoRequest\x1a\x12.echo.v1.EchoReplyB\x1fZ\x1dgrpcecho/proto/echo/v1;echov1b\x06proto3"
